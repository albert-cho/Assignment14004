...
public class LoanTableTests {
	...
	public void test() {
		...
		tLtable.createloan(1, "9781442668584", "1", tDate);
		Object ff = tLtable.createloan(1, "9781442616899", "1", tDate);
		
		assertEquals("The Maximun Number of Items is Reached", ff);
		...
		tLtable.returnItem(1, "9781442667181", "1", tDate);
		...
		assertEquals(false, tLtable.checkLoan("9781442668584", "1"));
		assertEquals(true, tLtable.checkLoan("9781611687910"));
		assertEquals(false, tLtable.checkLoan("9781442668584"));
	}
